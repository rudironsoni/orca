...
export function herdrStockCliPaneArgs(method: string, params: JsonRecord): string[] | undefined {
  switch (method) {
    case 'pane.split':
      return [
        'pane',
...
export function herdrStockCliAgentArgs(method: string, params: JsonRecord): string[] | undefined {
  switch (method) {
    case 'agent.list':
      return ['agent', 'list']
    case 'agent.get':
